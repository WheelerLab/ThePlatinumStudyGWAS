...
write.table(output, file=res.dir %&% "N88.imputed_" %&% phen %&% "_agediagnosis_chr" %&% chr %&% ".ordreg.assoc.dosage"
            ,quote=F,row.names=F)
...
write.table(output, file=res.dir %&% "N88.imputed_" %&% phen %&% "_agediagnosis.cisp.10PCs_chr" %&% chr %&% ".ordreg.assoc.dosage"
            ,quote=F,row.names=F)
